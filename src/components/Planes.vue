            ...
            <div class="q-pa-md">
              <q-form @submit.prevent="agregarPlan">
                ...
                <q-input v-model.trim="descripcion" label="Descripción" type="textarea" filled outlined class="q-mb-md"
                  required />
                <q-input v-model="valor" label="Valor" type="number" filled outlined class="q-mb-md" min="0" required />
                ...
                <div class="q-mt-md">
                  ...
                  <q-btn :loading="usePlan.loading" :disable="usePlan.loading" type="submit" label="Guardar plan"
                    color="primary">
                    <q-tooltip>
                      Guardar plan
                    </q-tooltip>
          ...
          <q-card-section>
            <div class="q-pa-md">
              <q-form @submit.prevent="editarPlan">
                ...
                <!-- Botones de acción -->
                <div class="q-mt-md">
                  <q-btn @click="mostrarFormularioEditarPlan = false" label="Cancelar" color="negative" class="q-mr-sm">
                    <q-tooltip>
                      Cancelar
                    </q-tooltip>
                  </q-btn>
                  <q-btn :loading="usePlan.loading" :disable="usePlan.loading" type="submit" label="Guardar cambios"
                    color="primary">
                    <q-tooltip>
                      Guardar cambios
                    </q-tooltip>
